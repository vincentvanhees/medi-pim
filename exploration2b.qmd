...
# Old code that assumed that epochs were alligned to the minute
...
### Plot only average line per Id

```{r}
output2 = aggregate(output[, c("time", "MEDI", "PIM", "changepoint")],
                    by = list(output$time, output$Id), FUN = mean)
...
output2 = output2[, -which(names(output2) %in% c("Group.1"))]
names(output2)[1] = "Id"
plot_changepoint_ts(output2, "high PIM => low PIM")
```
...
output2 = output2[, -which(names(output2) %in% c("Group.1"))]
names(output2)[1] = "Id"
plot_changepoint_ts(output2, "low MEDI => high MEDI")
```
...
output2 = output2[, -which(names(output2) %in% c("Group.1"))]
names(output2)[1] = "Id"
plot_changepoint_ts(output2, "high MEDI => low MEDI")
```
